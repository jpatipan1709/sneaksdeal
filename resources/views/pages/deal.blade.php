            ...
            <div class="col-lg-12 col-md-12 top2rem">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed"
                        ...
                        <div class="miniheadtext" style="color:  #3D3D3D;">ดีล {{$type}}

                        </div>
                        <div class="miniheadtext" style="color:  #3D3D3D;">
                            <input type="text" class="form-control empty" id="location_autocomplete" onchange="locationGet(this.value)" onblur="locationGet(this.value)"
                                   placeholder="&#xF002; Location ..." value="{{$search}}" style="border-radius: 20px;width: 250px">
                        </div>
                    </li>
                    @if(@count($voucher) > 0)
                                        ...
                                        <div class="row box">
                                            ...
                                            <div class="col-lg-7 col-md-6 col-12">
                                                <a href="{{ url('/voucherdetail',$rowVoucher->voucher_id) }}">
                                                    ...
                                                    <br>
                                                    <div class="detialtraveltext top1rem">{!! $rowVoucher->detail_main !!}
                                                    </div>
...
@section('scriptFront')
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#typeDeal").addClass("active");
            readPagination();
        });
        function readPagination() {
            var search = $('#location_autocomplete').val();
            $('.pagination-voucher li a').each(function () {
                var link_ = $(this).attr("href");
                $(this).attr("href",link_+'&search='+search)
            });
        }
