            ...
            <div class="card" style="position: relative; left: 0px; top: 0px;">
                <div class="card-header ui-sortable-handle" style="cursor: move;">
                    ...
                    <div style="float: right">
                        <a href="facilities/create" class="btn btn-flat btn-primary"><i class=" fa fa-plus-square"> </i>
                            เพิ่มข้อมูล</a>
                    </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <table class="table table-hover  table-bordered display responsive nowrap" id="table">
                        ...
                        <tr>
                            <th>No.</th>
                            <th>รูปภาพ</th>
                            <th>ชื่อสิ่งอำนวยความสะดวก</th>
                            <th>ID (ref Bulk upload)</th>
                            <th>
    ...
    <script>
            ...
            $(function () {
                var t = $('#table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{{ url('backoffice/index') }}',
                    columns: [
                        {data: 'No', name: 'No'},
                        {data: 'IMG', name: 'IMG', type: 'html'},
                        {data: 'name_facilities', name: 'name_facilities'},
                        {data: 'id_facilities', name: 'id_facilities'},
