...
@section('top1') Banner @endsection
            ...
            <div class="card" style="position: relative; left: 0px; top: 0px;">
                <div class="card-header ui-sortable-handle" style="cursor: move;">
                    ...
                    <div style="float: right">
                        <a href="banner/create" class="btn btn-flat btn-primary"><i class=" fa fa-plus-square"> </i>
                            เพิ่มข้อมูล</a>
                        <a href="banner/1" class="btn btn-flat btn-success"><i class=" fa fa-plus-square"> </i>
                                จัดการโลโก้</a>
                    </div>
                </div>
                <!-- /.card-header -->
    ...
    <script>
            ...
            $(function () {
                var t = $('#table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{{ url('backoffice/banner/data_table') }}',
                    columns: [
                        {data: 'No', name: 'No'},
                        {data: 'IMG', name: 'IMG', type: 'html'},
                        {data: 'link_banner', name: 'link_banner'},
