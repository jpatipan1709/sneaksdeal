            ...
            <div class="card" style="position: relative; left: 0px; top: 0px;">
                <div class="card-header ui-sortable-handle" style="cursor: move;">
                    ...
                    <div style="float: right">
                        <a href="blog/select_show" class="btn btn-flat btn-primary"><i class="fas fa-pen"></i>
                            เลือกแสดงหน้าหลัก</a>
                        <a href="blog/create" class="btn btn-flat btn-primary"><i class=" fa fa-plus-square"> </i>
                            เพิ่มข้อมูล</a>
                    </div>
                </div>
                <!-- /.card-header -->
    ...
    <script>
            ...
            $(function () {
                var t = $('#table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{{ url('backoffice/blog/data_table') }}',
                    columns: [
                        {data: 'No', name: 'No'},
                        {data: 'IMG', name: 'IMG', type: 'html'},
                        {data: 'name_blog', name: 'name_blog'},
                        {data: 'type_blog_', name: 'type_blog_'},
                        {data: 'time_work', name: 'time_work'},
                        {data: 'price_blog', name: 'price_blog'},
