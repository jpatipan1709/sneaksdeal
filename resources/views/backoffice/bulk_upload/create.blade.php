...
foreach ($data as $value){
  $optionBLog .=  '<option value="'.$value->id_main.'">--'.$value->name_main.'--</option>';
}
@endphp
@section('contents')
    ...
    <div class="row">
        ...
        <section class="col-lg-12 ">
            ...
            <div class="card" style="position: relative; left: 0px; top: 0px;">
                ...
                <!-- /.card-header -->
                <form name="frmCreate" id="frmCreate" method="post" action="{{ url('backoffice/voucher') }}" enctype="multipart/form-data">
                    @csrf
                    {{--{{ method_field('PATCH') }}--}}
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4"><br>
                                <div id="detailSwitch" class="form-group">
                                    <input type="number" name="qty_sale" id="qty_sale" required placeholder="QTY.."
                            ...
                            <div class="col-lg-6">
                                ...
                                {!! inputNumber('จำนวน Voucher', 'qty_voucher', 'id-input', 'Enter ...', 'lg-12', 'required',old('qty_voucher')) !!}
                            ...
                            <div class="col-lg-6">
                                ...
                                {!! inputTextArea('title', 'title_voucher', 'id-input', '', 'lg-12', 'required',old('title_voucher')) !!}
                            ...
                            <div class="col-lg-12">
                                {!! inputTimeRank('เวลาเปิดขาย:', 'time_open', 'reservationtime', 'time rank..', 'lg-12', 'required',old('reservationtime')) !!}
