        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {{--                        {{ $data->address_member.'     '.($data->d_name !="" ? 'ต.'.$data->d_name : $data->d_name ).'  '.$data->a_name.'    จ.'.$data->p_name.'    '.$data->zip_code }}--}}
                 {!! $ADDRESS !!}
                    </div>
                </div>
                <div class="row">
                    ...
                    <table class="table table-hover  table-bordered display responsive nowrap" id="table2">
                        ...
                        @foreach ($order_details as $KEY => $order_detail)
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    @if ($order_detail->discount_bath != null)
                                        {{ $order_detail->discount_bath }}
                                    @else
                                        {{ "-" }}
                                    @endif
                                </td>
                        ...
                        @endforeach
                        <tr class="text-right">
                            <td colspan="10"><b>ยอดรวม</b></td>
                            <td>
                                ฿ {{ $sum_order->total_sales }} บาท
                            </td>
                        </tr>
                        <tr class="text-right">
                            <td colspan="10"><b>ส่วนลด</b></td>
                            <td>
