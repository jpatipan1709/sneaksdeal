...
@section('top1') Logo @endsection

@section('top2') home @endsection

@section('top3') Logo detail @endsection
    ...
    <div class="row">
        ...
        <section class="col-lg-12 ">
            ...
            <div class="card" style="position: relative; left: 0px; top: 0px;">
                ...
                <!-- /.card-header -->
                <form name="frmCreate" id="frmCreate" method="post" action="{{url('backoffice/updatelogo')}}"
                    ...
                    <div class="card-body">
                        ...
                        if($logo != null) { 
                            $logo_url = url('storage/logo/'.$logo->name);
                        }else{ 
                            $logo_url = url('backoffice/dist/img/img-default.jpg');
                        }
                        @endphp
                        {!! uploadSingleImage( $logo_url ,'Upload Icon','Size<br>110 x45 ','lg-4 offset-lg-4','100%','200px') !!}
                       {!!  @$fileTo !!}
