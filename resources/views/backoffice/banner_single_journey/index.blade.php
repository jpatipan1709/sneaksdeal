            ...
            <div class="card" style="position: relative; left: 0px; top: 0px;">
                <div class="card-header ui-sortable-handle" style="cursor: move;">
                    ...
                    <div style="float: right">
                        <a href="banner_single_journey/create" class="btn btn-flat btn-primary"><i class=" fa fa-plus-square"> </i>
                            เพิ่มข้อมูล</a>
    ...
    <script>
            ...
            $(function () {
                var t = $('#table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{{ url('backoffice/banner_single_journey/data_table') }}',
                    columns: [
                        {data: 'No', name: 'No'},
